...
## ⟲ Resume — autonomous run, generated 2026-08-31 18:45 UTC
...
GOAL: pmOS fogyasztás felezése (≤50 mA) UT reagálási paraméterei mellett — a 8 órás modem-census (86 kör) eredményének feldolgozása és a következő lépések
  ...
  [ ] 2. ★ mA-ATVALTAS: a 86 kor v_uV oszlopa -> meredekseg -> mA a 2026-08-28_discharge-to-shutdown referencia-gorbevel. ☠️ A capacity oszlop hasznalhatatlan (fagyott integrator). Adapter kell a sleep-night-fit.py formatumara
  ...
  [ ] 4. ★ A MODELL ELLENORZESE: mA = 54,9 + 135 x duty AZ EBREN-ABLAKOKRA lett illesztve. Ez a futas az elso, ahol magas modem-duty (33,6%) EGYUTT all egy 93%-ban alvo AP-vel. Ha az aram nem a josolt ~100 mA, a modell alvo telefonra NEM ervenyes - es akkor a D-palya erteke sokkal kisebb, mint hittuk
