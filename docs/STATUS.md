...
## ⟲ Resume — autonomous run, generated 2026-09-01 15:30 UTC
...
GOAL: pmOS fogyasztás felezése (≤50 mA) UT reagálási paraméterei mellett — a 8 órás modem-census (86 kör) eredményének feldolgozása és a következő lépések
  ...
  [~] 15. ★★★★★ PERZISZTENS ALLAPOT: ez az egyetlen kategoria, ami tulel daemont, WiFit, kabelt, modem-power-cyclet, rebootot ES napszakot. Ket alcsoport, es szetvalaszthatok: (a) MODEM NV / carrier config - amit 08-31 reggel valami beleirt; (b) a HALOZAT allapota erre az IMSI-re. Szetvalasztas: detach+attach (a halozati oldalt ujraalkuja), illetve a modem NV/carrier-config olvasasa qmiclivel es osszevetes azzal, amit a leads/modem-carrier-config.md mar tud
        · ★ A KATEGORIA MEGMARADT, de atalakult: a 23. tetel szerint a referencia el es a halozat NEM a magyarazat ⇒ a 30 pontos kulonbseg STACK-kulonbseg, es van alakja: HETSZER HOSSZU EBREDESEK azonos ebredes-utem mellett. A megmaradt jeloltek: PDC/carrier config, a RAT-lista (IRAT-meres minden DRX-ciklusban), IMS-regisztracio
  ...
  […] 22. ★★ AZ ADSP-MECHANIZMUS: mi tartja ebren a q6-ot futo ModemManagerrel? Olcso olvasas egy booton belul, daemon le/fel: /sys/kernel/debug/asoc, apr/q6 kliensek, ill. a qrtr port-lista. Ha egy nyitott APR/q6 session a valasz, az korrektsegi hiba is lehet
        · ssh kell hozza, a 19. meres 16:02-ig fut; plusz a futas megallitva review-ra
...
**☠️ Results have landed that the plan does not mention yet:**
  ...
  - uncommitted changes under /mnt/1TB/pmos/fp3-pmaports/docs:
     ?? docs/power/bringup/captures/2026-09-01_radio-context-and-ipa/raw/pmos-nv-ims-fplmn-1730.txt
