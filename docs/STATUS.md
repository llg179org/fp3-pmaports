...
## ⟲ Resume — autonomous run, generated 2026-09-01 14:12 UTC
...
GOAL: pmOS fogyasztás felezése (≤50 mA) UT reagálási paraméterei mellett — a 8 órás modem-census (86 kör) eredményének feldolgozása és a következő lépések
  ...
  [~] 19. ★★★★★ A' KONTROLL a bearer-karra: bearer lebontva (--simple-disconnect, registered), minden mas azonos (mm=running, kabel be, WiFi fent), 1 ora, inditva 14:49:31, utolso kor ~16:02, dead-man 16:19. ☠️ ELORE ROGZITVE: ~34% ⇒ a bearer OKSAGI es a +15 pp az ove; ~48% marad ⇒ ez egy ujabb regime-valtas volt es a bearer-lelet n=1-re esik ossze. Tiszta host-oldali idozito figyel 16:06-ra; pingelni TILOS
        · ☠️☠️ A MERES NEM FUTOTT: a run.log szerint 14:49:31 indult es 14:49:56-kor mar 'RESTORED' - 25 masodperc, a 300 s-os settle kozben, egyetlen kor nelkul. A setsid+nohup nem tartotta eletben az ssh-session vegen. ES 77 PERCIG allitottam, hogy fut, es tiltottam a telefon erinteset. A hiba nem a szkript: a 'tiszta host-oldali idozito' EGY ORA, nem figyelo - nem tudott semmit megfigyelni, tehat nem is tudott megbukni. Ujrainditas systemd-run --unit-tal ES elenkseg-ellenorzessel a settle alatt
  ...
  [~] 24. ★★★★ SAV-LOCK LETRA: --nas-set-system-selection-preference sav-lockkal egy-egy ablak eutran-1 / -3 / -20-on. Ez az EGYETLEN ismert, KIKENYSZERITHETO nagy hatas (13,6 pp meres a repoban), es az eutran-20 (800 MHz) SOHA nem lett merve. Olcso, reboot-mentes. ☠️ Restore 'any'-vel, nem a kiirt listaval
        · ★★★★★ FELERTEKELODOTT ES FUT: a telefon MOST a DRAGA savon (eutran-1) all ⇒ ez nem elmeleti kar. Letra indult 16:09:50 systemd-run --unit=fp3-bandladder alatt: eutran-1 / eutran-3 / eutran-20 / eutran-1-repeat, 600 s ablak legenkent, ~16:54-re kesz. Elenkseg IGAZOLVA a leg-1-ben (active, band=eutran-1 chan=500 cell=1470762 rsrp=-94,4) - ezuttal figyelo van, nem idozito. ☠️ Az utolso leg megismetli az elso savot, kulonben a letra nem tudja megkulonboztetni a sav-hatast a driftt
  ...
  [ ] 29. ★★★★★ ☠️ A BEARER-LELET UJRA VESZELYBEN: a 09-01-i +15 pp (33,4-36,8% -> 48,8%) EPP AKKORA, mint a repo sajat sav-hatasa (eutran-3 36,4% -> eutran-1 50,0%), es a bearer-futas savja NINCS ROGZITVE. Ha a letra ma reprodukalja a sav-hatast, a bearer-magyarazatot vissza kell vonni es a merest a savra kontrollalva megismetelni
```
...
**☠️ Results have landed that the plan does not mention yet:**
  ...
  - uncommitted changes under /mnt/1TB/pmos/fp3-pmaports/docs:
     ?? docs/power/bringup/captures/2026-09-01_radio-context-and-ipa/
     ?? docs/power/bringup/tools/band-ladder.sh
