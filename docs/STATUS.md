...
## ⟲ Resume — autonomous run, generated 2026-08-31 05:50 UTC
...
GOAL: pmOS fogyasztás felezése (≤50 mA) UT reagálási paraméterei mellett — a keret: fp3-pmaports/docs/power/NEXT-RUN.md
  ...
  […] 25. PRONTO s2idle ALATT: ebren marad-e? A javitott muszer szerint a PRONTO 16,7-26,7%-ban ebren van MINDKET rendszeren, de kizarolag EBREN-ablakokban merve. A 18. tetel (mi viszi a ~41 mA-t s2idle-ben) szempontjabol pontosan a masik allapot szamit, es azt soha senki nem merte. ☠️ Elore rogzitve: ha a PRONTO s2idle alatt is ~20%-ban ebren van, uj nevesitett fogyaszto a padlon; ha lemegy, akkor a PRONTO teljesen kiesik a 18-bol es marad az USB-link (11. tetel). ☠️☠️ A tartomanyok ATFEDNEK a ket rendszer kozott - ez NEM differencial, tehat onmagaban nem magyarazza a pmOS-UT kulonbseget, csak a padlo egy tetelet
        · A kerdes ELSO fele MEGVAN (a WiFi benne van a padloban, es a kar mert). A masodik felehez - MENNYIBE KERUL mA-ben - egy ejszaka-hosszu kar kell: ugyanaz a sleep-night.sh ugyanazokkal a kapukkal, de wlan0 DOWN-nal; a 'wlan up' kar mar megvan (48 +/- 5 mA, 10,02 h). ☠️ Ez 8-10 orara lefoglalja a telefont es most 07:50 van ⇒ a TELEFON ELERHETOSEGE a felhasznalo dontese, nem az enyem. ☠️ Ket kapu a futashoz: az akku 100% Full (eloszor toltes-input le + felszini toltes lecsengese), es a wlan0 a masodik dev-link, tehat a szkriptnek minden kilepesi agon vissza kell hoznia
```
