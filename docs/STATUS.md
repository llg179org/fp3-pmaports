...
## ⟲ Resume — autonomous run, generated 2026-09-02 08:26 UTC
...
GOAL: pmOS fogyasztás felezése (≤50 mA) UT reagálási paraméterei mellett — a 8 órás modem-census (86 kör) eredményének feldolgozása és a következő lépések
  ...
  [ ] 33. ★★ A PONTOSITOTT ADSP-KERDES: mi tortenik az ADSP-vel a SUSPEND alatt, ha a ModemManager fut? A kulonbseg csak ott letezik. Jelolt: a daemon suspend-handshake-je (terse) valamit felebreszt vagy nyitva hagy a freeze pillanataban. Muszer: LPASS-szamlalo a suspend ket oldalan, MM futo/leallitott karral, UGYANABBAN a bootban - ez mar a modem-night.sh formatuma, csak 2x2 kor kell hozza
        · ☠️ REOPENED: a varakozasi ok LEJART: a 78. cenzus 08:15-kor vegzett, a telefon 10:19-kor szabad (100%, kabelen, fp3-measure --status: semmi nem mer). Ujranyitva.
  ...
  [ ] 63. ★★★★★ ELERHETOSEG-TESZT VEGLEGES FORMAJA (Fable #13 b) - a 60. tetel elesitese: (1) COLD BOOT a boot-asszertalo szolgaltatassal, NE kezzel epitett allapotbol (a MM-nem-enumeral lelet mutatta, hogy a kezi es a bootolt allapot nem ugyanaz a rendszer); (2) ★ KORONA-TESZT: alvo AP + akkun + IMS off + bejovo hivas -> felebred ES cseng; (3) reboot-ateles: az iras perzisztens, tehat reboot utan is csengenie kell; (4) SMS mindket irany kulon tetel (IMS-rol SGs-re esik vissza - atkapcsolas, nem magatol ertetodes). ☠️ A CS-attach/SGs csak PREDIKTOR; kapukent egyedul a csenges fogadhato el. ☠️ Diag-paging-megfigyelessel NE valtsd ki - a maszk kontaminal
        · ☠️ REOPENED: UJRANYITVA MAS ALAKBAN: a felhasznalo Androidon 1 oras idozitot allit be es NAPPAL hiv orankent egyet - nem ejszaka, nem SIP, nem kolt ra. Ez megoldja a bontas-problemat is (kezzel bontja). MERESI KOVETKEZMENY: az orankenti koz mar ELERI a veszelyes sarkot (a mai N=4 percnyi kozokkel meg nem), es napok alatt gyulik N. A telefon oldalan kell egy ALLANDO, ujrainditasallo rogzito (nem RuntimeMaxSec-es!), ami minden ringing-in eventet naploz, hogy a felhasznalonak semmit ne kelljen jelentenie a hivason kivul.
  ...
  […] 81. ★★★★ A MERES-INDITO WRAPPER (Fable #4 b): a PreToolUse-kapu mintazat-alapu es CSAK a sajat sessionomben fut - egy masik terminal kezi inditasat nem latja. A helyes forma EGYETLEN belepesi pont (fp3-measure wrapper), ami maga olvassa a consulting-allapotot ES egy ESZKOZ-OLDALI zarat ⇒ az ervenyesites GEP-SZINTU lesz, nem session-szintu, es egyszerre zarja a tobb-gep- es a kezi-ssh-lyukat. A wrapper kovetelhet ETA-t is (a meres+figyelo=egy-objektum szabaly odakoltozik). A PreToolUse szerepe utana SZUK: a nyers indito-formak (systemd-run/nohup/setsid) tiltasa 'a wrapperen at' uzenettel - nem a hosszu munkat ismeri fel, hanem a wrapper MEGKERULESET
        · az eszkoz-oldali lockfile-hoz a telefon kell; a cenzus ~08:15-ig fut. A ket session-oldali resz (wrapper + bypass-kapu) kesz es megmutatva
  […] 82. ★★★ KAPU-NAPLO ES FELULVIZSGALATI DATUM (Fable #4 c): minden kemeny kapu hordozzon incidens-linket, TUZELES-NAPLOT es SUNSET-DATUMOT. Most minden kapu felmutat egy incidenst, de a forditott kerdest senki nem teszi fel: tuzelt-e meg JOGOSAN azota? Harom meroszam: (1) karbantartasi hanyad (hook-szerkesztesek aranya az osszes munkahoz, git-tortenetbol), (2) kapunkenti precizio (tuzelesek jogos/hamis cimkevel; ha a hamis-blokk-rata meghaladja a fogasokat, NETTO NEGATIV), (3) felulbiralasi rata (--force, claim --force, consulted none). ☠️ A netto irany addig rendben, amig a KIVETEL ugyanolyan olcso, mint a HOZZAADAS - ahogy a drop-nak ugyanolyan olcsonak kell lennie, mint az add-nak
        · a jogos/hamis cimkezeshez TUZELESEK es ido kell - ez a mechanizmus most all fel, az ertekelese napok mulva esedekes
...
```
OUTSIDE REVIEW: last 1.0 h ago, 5 result(s) recorded since.
  · Fable #6 MEGJOTT, a szamai ellenorizve (0,05^(1/4)=0,4729; 0,05^(1/20)=0,8609; ln0,05/ln0,95=58,4 => 59 siker; 90 mAh/2,5 o = 36 mA). NEGY ELOIRAS: (1) ☠️ A LEGGYENGEBB LANCSZEM A HIVHATOSAG, NEM AZ ARAM: negy sikerbol a kezbesitesi valoszinuseg 95%-os egyoldali also korlatja (Clopper-Pearson) 0,473 - vagyis a 4/4 AZZAL IS KONZISZTENS, hogy minden masodik hivas elveszik. Ketto kulon allitas: 'a hivas-ut MUKODIK IMS=off mellett' N=4-gyel LEZARHATO (funkcionalis bizonyitek), de 'a kezbesitesi RATA nem romlott' NEM - es a mintavetel a veszelyes sarkot (orak tetlenseg utani paging) nem is erinti. A jelentesnek KI KELL MONDANIA a 0,473-at az N=4 mellett. p>=0,95-hoz 59, p>=0,99-hez 299 egymas utani siker kell. Es a '6+1-2 s a halozate' ATTRIBUCIO MERES NELKUL - hipotezisnek cimkezni, vagy az orakulum-sloton merni. Gep-csak ut letezik: SIP/VoIP-szamlarol utemezett ejszakai hivasok (N=30, hosszu tetlen kozokkel), nem kell masodik ember. (2) BOOTSTRAP n=7-NEL NE: a sajat farkat becsli, a lefedettseg kis n-nel bizonyitottan rossz => t-alapu sav (df=6, t=2,447 * s/sqrt(7)) VAGY 'n=7, terjedelem X-Y, indikativ'. ES a B labra is: MINDKET sav csak a LABON BELULI zajt tartalmazza; a helyes felirat '+-1,0 (labon beluli; boot-kozti ismeretlen)', es a boot-kozti szorast a HAROM LAB-ATLAG szorasabol kell szamolni, nem az osszeontott ablakokebol. (3) AZ OCV-TERV MODOSITVA: a rest-arany a blokkhoz kepest -10%-ot torzit (a rest kisebb aramu, lefele huz) => a KULSO OCV-PAR AZ EGESZ EJSZAKAT fogja kozre (este rest+OCV, hajnalban rest+OCV), a 3-bootos replikacio pedig a QG-labakbol jon kozben; nem kell labankent OCV. A maradek aszimmetria (esti rest magasabb aramu eleletbol) ~3 mA, a hibasavba irando. (4) SZABALLYA TENNI: publikalt szam CSAK repo-beli szkriptbol johet, a tablakat a szkript GENERALJA, ne kezzel masoljam - akkor a kovetkezo elteres futasi hibakent bukik ki. Es a meres-wrapper koveteljen tervezett idotartamot es UTASITSA EL az inditast, ha a sajat RuntimeMaxSec-je/ablaka rovidebb - a 'muszer elettartama rovidebb, mint a meres' hibaosztaly egy koron belul KETSZER fordult elo.
```
