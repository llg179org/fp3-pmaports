...
## ⟲ Resume — autonomous run, generated 2026-09-01 15:18 UTC
...
GOAL: pmOS fogyasztás felezése (≤50 mA) UT reagálási paraméterei mellett — a 8 órás modem-census (86 kör) eredményének feldolgozása és a következő lépések
  ...
  […] 15. ★★★★★ PERZISZTENS ALLAPOT: ez az egyetlen kategoria, ami tulel daemont, WiFit, kabelt, modem-power-cyclet, rebootot ES napszakot. Ket alcsoport, es szetvalaszthatok: (a) MODEM NV / carrier config - amit 08-31 reggel valami beleirt; (b) a HALOZAT allapota erre az IMSI-re. Szetvalasztas: detach+attach (a halozati oldalt ujraalkuja), illetve a modem NV/carrier-config olvasasa qmiclivel es osszevetes azzal, amit a leads/modem-carrier-config.md mar tud
        · a 23. tetel (orakulum-ujrameres slot-valtassal) donti el, hogy ez a kategoria egyaltalan letezik-e; az A' meres 16:02-ig fut
  ...
  […] 23. ★★★★★ ORAKULUM-UJRAMERES MA, SLOT-VALTASSAL - a review legnagyobb lelete: a 6,1% egy NAPOKKAL EZELOTTI szam, es az egesz 'perzisztens allapot' vadaszat arra epul, hogy ma is igaz. Ugyanazon a delelotton mindket slot, AZONOS muszerkeszlet: XO-duty + ebredes-hossz, sav/cella/RSRP, PDC aktiv config, system-selection-preference, IMS-reg, CS+PS attach. ☠️ ELORE ROGZITVE: orakulum ma is ~6% ugyanazon a cellan ⇒ valodi stack/NV-diff es a diff ott olvashato ahol allunk; orakulum ma ~30+% ⇒ A REFERENCIA ELAVULT, a perzisztens-allapot vadaszat LEALL, es a kerdes az lesz, melyik halozati feltetel adja az olcso regime-et es kerhet-e ilyet a UE. ☠️ FELHASZNALOI JOVAHAGYAS kell (slot-valtas)
        · az orakulum-oldali 600 s-os ablak fut (ut-window, inditva 17:15:45, active), ~17:26-ra kesz; utana lehuzas, osszevetes, majd set_active b vissza. ★ MAR MOST MEGVAN a kulcs-kovarians: az orakulum a cella 1470762-n ul = az eutran-1 (DRAGA sav) cellaja, mikozben a pmOS a 1470722-n (eutran-20) mert 37,4%-ot. Ha az orakulum ezen a cellan is ~6%, a sav NEM magyarazza a stack-kulonbseget. ☠️ Az UT-n NINCS qmicli (csak /dev/smdcntl0), tehat a sav/RSRP csak ofonobol jon - a modem-window.sh ezt kimondja, nem hallgatja el
  ...
  […] 26. ★★ AZ EBREDES-UTEM AZ ORAKULUMON: a 2,4/s XO-elhagyas RAT-fuggetlen nalunk; ha az orakulum is 2,4/s-sel ebred csak rovidebben, a mechanizmus AZONOS es a kerdes tisztan 'mitol hosszu az ebredes'; ha ritkabban, akkor eDRX/hosszabb paging-ciklust alkudik ki ⇒ config-diff. A 23. tetel meresevel egy menetben
        · a 23. tetel meresevel egy menetben; az A' 16:02-ig fut
