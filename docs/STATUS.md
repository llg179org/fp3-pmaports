...
## ⟲ Resume — autonomous run, generated 2026-09-03 05:46 UTC
...
GOAL: Stabil telefon-mukodes MINIMALIS fogyasztassal, a LEHETO LEGROVIDEBB tesztelesi idotartam mellett. ☠️ A tesztelesi ido mostantol KOLTSEG, nem szabad eroforras - egy ejszaka-hosszu lab ara nem nulla. Lezarando minel hamarabb: a pmOS ketszeres fogyasztasa UT-hez kepest (a 40,3 mA olcso allapot + 14/14 hivas mar a felezes alatt van; hianyzik a boot-kozti hibasav es a kalibracios offset). Az upstream ELINDULT => ami LKML-re kuldheto, annak MOST van erteke.
  ...
  […] 19. ★★★★★ A' KONTROLL a bearer-karra: bearer lebontva (--simple-disconnect, registered), minden mas azonos (mm=running, kabel be, WiFi fent), 1 ora, inditva 14:49:31, utolso kor ~16:02, dead-man 16:19. ☠️ ELORE ROGZITVE: ~34% ⇒ a bearer OKSAGI es a +15 pp az ove; ~48% marad ⇒ ez egy ujabb regime-valtas volt es a bearer-lelet n=1-re esik ossze. Tiszta host-oldali idozito figyel 16:06-ra; pingelni TILOS  (after 116)
        · AZ imsd-JOVO ARAZASA, a 116. UTAN (Fable #15). ☠️ A regi jegyzet a 30-ra mutatott es egy elavult idozitore hivatkozott. Uj indok: a 19+30+31 EGY csomag ('ha sub-40-et vagy imsd-t akarunk, egy sav-lockolt ejszaka'), es a 116. eredmenye nelkul nincs miert merni - ha a policy nem enged VoLTE-t ennek a keszuleknek, a bearer-arazas targytalan.
  ...
  […] 30. ★★★★★ A BEARER-KAR UJRAMERESE SAV-LOCKKAL: ugyanaz a kar (mm=running, kabel be, WiFi fent), de MINDKET lab eutran-3-ra (vagy -20-ra) lockolva, bearer fel/le. Ez az egyetlen modja, hogy az adat-context koltsegerol barmit mondjunk  (after 116)
        · AZ imsd-JOVO ARAZASA, a 116. UTAN (Fable #15). ☠️ A regi jegyzet a mar lezart 23. tetelre mutatott. A sav-lockolt bearer-par a 19+30+31 csomag magja, es a 116. dontese utan kerul sorra - nem elotte.
  ...
  […] 41. ★★★ A KOVETKEZO SLOT-VALTAS UJRADEFINIALVA (Fable #4): NEM pref-olvasas, hanem SAV-ILLESZTETT ORAKULUM-LAB eutran-1-en, teljes kovarians-keszlettel. Ez a KONSTANS-SZORZO tesztje: ha a stack minden radio-munkat ugyanannyival nyujt, akkor a mi-duty/orakulum-duty allando cellak kozott (egy pontunk van: 37,4/6,9 = 5,4x) => eutran-1-en ~9%-ot josol; ha kulon tagok, ~7%-ot. ☠️ FELHASZNALOI JOVAHAGYAS kell  (after 116)
        · A 116. ORAKULUM-SESSION 4. SORA (Fable #15). ☠️ A regi jegyzet ELAVULT volt ('a telefon foglalt' + a modem-story-ra hivatkozott, ami azota PARKOL). Ez a tetel onallo utemezest nem kap: a sav-illesztett fogyasztas-ablak a slot-valtas vegen fut, ugyanabban a menetben.
  ...
  […] 54. ★★★ DIAG OTA-CAPTURE az orakulum sloton: RRC connection-request cause + NAS/ESM uzenettipusok, ~10 perc log. Ez nevezi meg az ismetlodo eljarast, amit az OTA-TX jelez. A repo diag-eszkozei megvannak (diag-probe.py, diag-handshake.py, leads/diag-bringup.md), es az orakulumon a vendor-tooling is elerheto  (after 116)
        · A 116. ORAKULUM-SESSION 3. SORA (Fable #15). ☠️ A regi jegyzet ELAVULT: a 'certify-ablak + modem-story utan' sorrendet mondta, de az 53. (modem-story) azota PARKOL - egy parkolo tetelre varni annyi, mint sose sorra kerulni. A DIAG OTA-capture a savval es a pref-fel egyutt megy, a session harmadik sorakent.
  […] 55. ★★ ATTACH-PDN LISTA mindket sloton (Fable #8 - EZ tenyleg olvasatlan, a PDC-vel ellentetben, amit a 25. tetel mar kiolvasott). A bindolt-QMI olvasoval (WDS), az orakulum-slotos menetben  (after 116)
        · A 116. ORAKULUM-SESSION 2. SORA (Fable #15). ☠️ A regi jegyzet a modem-story.sh-hoz kototte, ami azota PARKOL. Az attach-PDN lista onalloan is megy (a qmicli-nek van sima --wds-get-... getterje), es a vendor-oldali olvasas a session masodik sora.
  ...
  […] 64. ★★★ A 'MIERT BONT' - EGYETLEN, HATAROLT ~30 PERCES CAPTURE (Fable #13 d): IMS/QIPCALL log-csaladok (0x14, 0x15) a mar nyitott kontroll-ajton, maszk-nullazo teardownnal, hogy az IMS allapotgep a SAJAT SZAVAIVAL mondja meg, miert bont 30 ms-cel az elfogadas utan. Az upstream-ertek es a jelentes teljessege miatt eri meg. ☠️ Az imsd-ut (az AP-oldali fel megepitese, ami VoLTE-t adna) KULON PROJEKT, kulon dontessel - nem ennek a szalnak a farka; a cel <=50 mA hivasfogadassal volt, es azt a CSFB adja  (after 116)
        · A 116. MOGE PARKOLVA (Fable #15): a P-CSCF-lelet ota a 'miert bont 30 ms utan' NEM dont el semmit, amig a 116. ki nem mondta, hogy az imsd-ut egyaltalan el. A fo terhet - vart-e a halozat egyaltalan IMS-t adni - a PCO-fejtes levette; ami maradt, az az imsd-EPITES UTANI hibakereseshez kell. ☠️ Es a DIAG-folyam allapota is valtozhatott: a ma esti 3 reboot haromszor ujrainditotta a modemet, ezt a reggeli 2 perces szonda meri (109.).
  ...
  […] 72. ★★★★ KUSZOB-IDO MODSZER (kalibracio nelkuli aram-arany): azonos indulo (radio-ki restben olvasott) feszultsegrol merd, mennyi ido alatt er el egy rogzitett kuszobot A-ban (IMS on) es B-ben (IMS off). Azonos vegpontok => azonos dmAh => I_A/I_B = t_B/t_A, gorbe-lekepezes NELKUL; az abszolut skalat a 86+/-4 mA-es horgony adja. Ez a legolcsobb ut egy VEDHETO aranyszamhoz
        · FELTETELES TARTALEK (Fable #15): csak akkor el, ha a ma esti kulso OCV-parbol szamolt |eps| <= 1,49 (delta + I|g|) korlat ELBUKIK - vagy ha a merleg azt mutatja, hogy a pakk toltott valamelyik reboot-hataron (akkor a teljes-ejszakai korlat eleve nem all). Ora-hosszan suti az akkut; ha az OCV-korlat all, ez a tetel megszunik.
  ...
  […] 79. ★★★★★ SONT-KALIBRACIO - AZ EGYETLEN TANU, AMI NEM A PMI632-N MEGY AT (Fable 5.1 c): a projekt MINDEN aram-szama egyetlen kalibracion ul - a QG-akkumulator, a current_now, ES a 2185 mAh-s referencia-gorbe is (annak mAh-tengelye ugyanennek a chipnek a cur_uA-jabol integralodott). Az ERSITES-hiba masodrendu (5% = 2,5 mA 50 mA-nel), de az OFFSET-hiba a '48 mA cel teljesitve' es az '58 mA nem' kozott dont. Az FP3 akkuja KIVEHETO ⇒ sont sorban a pakk es az erintkezok kozott + kulso multimeter, EGYSZERI egyideju kalibracio (gain+offset), nem cenzus. ☠️ Csapda: az akku-ID/termisztor-pineket NE szakitsa meg a sont. ☠️ EZ KAPUZZA a <=50 mA ABSZOLUT allitas kimondasat - a kulonbseg-allitast nem
        · ★ NEM BLOKKOL, hanem EROSIT (Fable #15): a lezaras kimondhato a '|eps| <= 1,49 (delta + I|g|) az OCV-tanubol' formaban, es a sont KESOBB frissiti abszolutra. A felhasznalo utemezi - NE varjam meg. ☠️ A korlat JAVITVA (e386306): a levezetes a kisutes MEDIANJAT (108, '~110') hasznalta ott, ahol az ATLAG kell (2185 mAh / 17,94 h = 121,8 mA), mert a mAh-tengely INTEGRAL - a publikalt 1,6 delta konzervativ volt, nem hibas.
  ...
  […] 85. ★★★★★ REPLIKACIO 3 BOOTON, 2 NAPON + OCV-VS-QG (Fable 5.1 c, ejszakai terv): 3x { reboot -> reconciler konvergal (naplobol bizonyitva) -> radio-ki rest + OCV -> B-cenzus 90 s-os ebresztovel 60-90 perc -> rest + OCV }, hajnalban egy A-lab kontroll. Egyszerre adja: a 40 mA replikaciojat 3 booton (a visszatero hibamintank ellenszere: egy boot allapota != a telefon tulajdonsaga), az OCV-vs-QG offset-korlatot, a reconciler boot-utani viselkedesenek 3x eles bizonyitekat, es 90 s-nal labankent 2-3x tobb megtartott ablakot.  (after 120, 121)
        · INDITAS BEALLITVA (a Fable #18 legfontosabb mondata): fp3-night-start.timer telepitve es engedelyezve, OnCalendar 19:00, ellenorizve: 'Thu 2026-09-03 19:00:00 CEST, 11h left'. A unit ENABLE-oli ES INDITJA a fp3-night.service-t (enable KELL, mert a futas 3x rebootol), majd LETILTJA SAJAT MAGAT - kulonben holnap 19:00-kor ujra inditana egy ot oras merest egy hasznalt telefonon. Persistent=false SZANDEKOSAN: egy kihagyott 19:00 NEM sulhet el a kovetkezo booton, mert a futas sajat bootjai 19:00 UTAN vannak - egy persistent timer a futason BELULROL ujraarmazna a futast. systemd-analyze verify rc=0; fp3-night meg disabled; a futas-konyvtar nem letezik (tiszta indulas). ★ ES MERVE, NEM FELTETELEZVE: a KABEL bedugva a replikaciot NEM viszi el - a night-run.sh:313 MAGA vagja el az USB-bemenetet kozvetlenul a lab elott ('USB input off so the leg measures the phone, not the charger'). A bedugott kabel az EJSZAKAI OCV-korlatot viszi (a reboot-szakaszok pozitiv tagja), plusz 100%-on a feszultseg-muszer a lapos teton vak. Tehat: fele ejszaka, nem egesz.
  ...
  [x] 109. ★★★★ A REGGELI TRIAZS LEFUTTATASA az ejszakara (night-triage.sh, mar telepitve): 1. interferencia-audit, 2. vektor-kapuk + dobott labak, 3. sav-naplo, 4. OCV-vegpontok leulepedese, 5. a szamok, 6. boot-kozti szoras a LAB-ATLAGOKBOL. Ervenyesseg eloszor - egy zavart lab szama akkor sem hihetobb, ha szep.  ⟨docs/power/bringup/captures/2026-09-02_night-replication/triage-output.txt⟩
  ...
  […] 118. ★★★★ AZ EJSZAKAI MERLEG KIERTEKELESE az eloregisztralt savok ellen (b45d9c5): night-budget.py a run.log-on -> (1) toltott-e a pakk barmelyik reboot-hataron [feszultseg-emelkedes]; (2) ha nem: dQ(kulso OCV-par) =? szegmensek osszege, 10%-os kuszobbel; (3) lab-atlagok es a boot-kozti szorasuk. ☠️ A teljes-ejszakai atlagot SEMMIVEL nem szabad osszevetni - az a merleg egyik oldala, nem osszehasonlito szam; a regi tetlen letrakkal CSAK szegmens-szinten (lab vs lab)  (after 109)
        · a reggeli triazsra - az ejszaka hajnali 2-3 kozott vegez, a szkript es az eloregisztralt savok keszen allnak (b45d9c5)
  [-] 119. x
        · elgepeles
  [x] 120. ★★★★★ MIERT NEM ALUDT AZ AP a 09-02-i lab1-ben? 11 s median alvas a 90 s-os ebreszto ellen, MIKOZBEN a 09-02 reggeli cenzus B-laba 62 s-ot aludt UGYANAZON a konfiguracion. Ket gyanusitott a naplobol: (a) NetworkManager Script Dispatcher indult a labba - miert, es mi valtotta ki (a sav-pineles mmcli-hivasa? a bemenet-felfuggesztes network-change-kent?); (b) a lab kozvetlenul boot+50 s utan indult, a reconciler konvergalasa utan - lehet, hogy a boot utani ~perceк meg nem nyugodt allapot. ☠️ EZ KAPUZZA a kovetkezo ejszakat: ujabb ejszaka egy ismert, diagnozalatlan ebresztoforrasra pazarlas  ⟨commit:7b97791⟩
  ...
  […] 124. ★★★ A QG NYERS SZAMLALO KITETELE MAINLINE-RA (CHARGE_COUNTER a qcom_smbx/QG driverben): a hajcsar-listan OT QG-tetel van (71/78/80/84/92) es MIND a userspace-MUSZERROL szol; a 71. pontosan ott all meg, ahol a driver-munka kezdodne. A hiany a docs/TODO.md:744-745-ben KERDESKENT ki van mondva ('whether the PMI632 QG block can expose a raw count to mainline ... is unanswered'), de nincs mogotte TETEL - egy allitas, ami egy dokumentumban el, de nincs allapota. Erintene: POWER_SUPPLY_PROP_CHARGE_COUNTER, wip/<base>/charger -> integration -> debug-int, _commit-bump. ☠️ NEM most: a mert rendszert a 85. lezarasa elott nem bolygatjuk
        · A 85. REPLIKACIO UTAN (a driver a mert rendszer resze - egy charger-valtozas a mereskozi ejszakat ervenytelenitene). ☠️ ES A SORREND A FELHASZNALOE: ez konyveles-javitas, nem menetrend. Forras: docs/TODO.md:744-745; a szomszedos T1 (learned charge_full, r79) mar megepult, tehat a driver-oldali ut jart
```
...
**☠️ Results have landed that the plan does not mention yet:**
  ...
  - uncommitted changes under /mnt/1TB/pmos/fp3-pmaports/docs:
     ?? docs/power/bringup/tools/fp3-night-start.service
     ?? docs/power/bringup/tools/fp3-night-start.timer
