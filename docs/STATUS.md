...
## ⟲ Resume — autonomous run, generated 2026-09-01 09:58 UTC
...
GOAL: pmOS fogyasztás felezése (≤50 mA) UT reagálási paraméterei mellett — a 8 órás modem-census (86 kör) eredményének feldolgozása és a következő lépések
  ...
  [~] 11. ★★★★★ REBOOT-TESZT: a duty EGY BOOTON BELUL ugrott 5% -> 34% (uptime 16 h vs 22+ h) es 28 ora ota ott all minden konfiguracioban. Parositott par: UGYANAZ a beallitas (kabel be + bemenet elvagva, WiFi fent, 12 ablak 44 h uptime-nal), csak az uptime ter el. ☠️ ELORE ROGZITVE: ~5% friss booton ⇒ a duty PER-BOOT allapot ami romlik, es az 5% parancsra eloallithato; ~36% ⇒ nem az uptime, es a 08-31 reggeli epizod magyarazatlan marad. ☠️ A rebootot a classifier letiltotta - FELHASZNALOI JOVAHAGYAS kell
        · FUT: reboot 11:56:42, boot 48 s, modem registered 11:57:50. fp3-ladder inditva 11:58:07 (modem-night.sh 3 600 15 stopped up in) - PONTOSAN ugyanaz a kar, mint a 12 ablak 44 h uptime-nal, csak az uptime ter el (most ~1 perc). Akku 52%. Utolso kor ~15:10, dead-man 15:28. Korai ellenorzopont 13:05-re: mar az elso ora eldonti, visszajott-e az 5%
  ...
  [~] 13. ★★★★★ AZ ATMENET ELKAPASA (a 'mitol' kerdes): egyik mai kar sem mondja meg, mi emeli a dutyt 5%->36%-ra - csak azt, hol lakik az allapot. DUTY-LETRA az uptime menten: reboot utan 10-15 percenkent egy 600 s-os ablak, amig a lepcso be nem kovetkezik. Ez adja a MIKOR-t, es a lepcso alakja (ugras vs lassu emelkedes) a MIT-et. A tools/duty-vs-uptime.sh pont ezt kerdezi es hasznalatlanul all a repoban
        · A letra EL IS INDULT ugyanezzel a futassal: 3 ora, 10 percenkent egy 600 s-os alvas, t_h oszloppal. Ha az elso ora 5%-ot mutat, a futast toltessel engedelyezve hosszabbitom, hogy a lepcso (mult alkalommal 16 h es 22 h uptime kozott) is belefertjen
