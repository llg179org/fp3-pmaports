...
## ⟲ Resume — autonomous run, generated 2026-09-02 06:24 UTC
...
GOAL: pmOS fogyasztás felezése (≤50 mA) UT reagálási paraméterei mellett — a 8 órás modem-census (86 kör) eredményének feldolgozása és a következő lépések
  ...
  […] 63. ★★★★★ ELERHETOSEG-TESZT VEGLEGES FORMAJA (Fable #13 b) - a 60. tetel elesitese: (1) COLD BOOT a boot-asszertalo szolgaltatassal, NE kezzel epitett allapotbol (a MM-nem-enumeral lelet mutatta, hogy a kezi es a bootolt allapot nem ugyanaz a rendszer); (2) ★ KORONA-TESZT: alvo AP + akkun + IMS off + bejovo hivas -> felebred ES cseng; (3) reboot-ateles: az iras perzisztens, tehat reboot utan is csengenie kell; (4) SMS mindket irany kulon tetel (IMS-rol SGs-re esik vissza - atkapcsolas, nem magatol ertetodes). ☠️ A CS-attach/SGs csak PREDIKTOR; kapukent egyedul a csenges fogadhato el. ☠️ Diag-paging-megfigyelessel NE valtsd ki - a maszk kontaminal
        · a 60. tetellel egy menetben, reggel - cold boot + a felhasznalo hivasa/SMS-e kell hozza
  […] 64. ★★★ A 'MIERT BONT' - EGYETLEN, HATAROLT ~30 PERCES CAPTURE (Fable #13 d): IMS/QIPCALL log-csaladok (0x14, 0x15) a mar nyitott kontroll-ajton, maszk-nullazo teardownnal, hogy az IMS allapotgep a SAJAT SZAVAIVAL mondja meg, miert bont 30 ms-cel az elfogadas utan. Az upstream-ertek es a jelentes teljessege miatt eri meg. ☠️ Az imsd-ut (az AP-oldali fel megepitese, ami VoLTE-t adna) KULON PROJEKT, kulon dontessel - nem ennek a szalnak a farka; a cel <=50 mA hivasfogadassal volt, es azt a CSFB adja
        · a telefonra; egyetlen ~30 perces diag-ablak, a 78. cenzus utan
  ...
  […] 70. ★★★★★ ELERHETOSEG N=1 -> N=20+: a paging SZTOCHASZTIKUS, es most egy hivas + egy SMS all mogotte. Kell egy automatizalt ejszakai sorozat: 20+ bejovo hivas kezbesitesi idovel (csenges-kesleltetes eloszlas), alvo AP-vel, akkun, a szallithato konfiguraciobol. ☠️ Ez ugyanaz a lecke, mint a hangszoro-saga: egy boot allapotat ne mondjam ki a telefon tulajdonsagakent. Kell hozza egy masodik keszulek vagy egy hivas-generator
        · masodik keszulek vagy hivas-generator kell hozza, es egy ejszakai ablak; a felhasznalo bevonasa nelkul nem megy
  ...
  […] 72. ★★★★ KUSZOB-IDO MODSZER (kalibracio nelkuli aram-arany): azonos indulo (radio-ki restben olvasott) feszultsegrol merd, mennyi ido alatt er el egy rogzitett kuszobot A-ban (IMS on) es B-ben (IMS off). Azonos vegpontok => azonos dmAh => I_A/I_B = t_B/t_A, gorbe-lekepezes NELKUL; az abszolut skalat a 86+/-4 mA-es horgony adja. Ez a legolcsobb ut egy VEDHETO aranyszamhoz
        · a telefonra: a 78. cenzus fut ~08:15-ig, es ez is ora-hosszu, akkun, radio-ki restekkel
  ...
  […] 75. ★★★★ KI IRJA VISSZA - 0. LEPES, egy reboot, nulla kockazat: MM --log-level=DEBUG drop-in + reboot. Debug szinten a MM MINDEN QMI TX/RX-et naplozza ⇒ ha o az iro, a boot-naplo megnevezi a sajat irasat; ha nulla IMSS-iras van es a vektor megis visszaallt, a MM FELMENTVE. Csak utana a maszkolt boot, es annak HAROM buktatojaval: D-Bus-aktivacio (pgrep-pel bizonyitsd a tavolletet), az rmtfs MARADJON futni (o szolgalja a modem NV-tarat), es KETSZER olvass szethuzva (boot+60 s, boot+300 s) mert a revert lehet SIM-detektalas/MCFG utani, kesleltetett
        · a felhasznalo jovahagyasara a rebootra; minden elo van keszitve (reconciler-timer aktiv + MM debug drop-in telepitve), es egy reboot ket kerdest valaszol meg egyszerre
  […] 76. ★★★★ KET CHECK A SELFTEST-BATTERIABA (Fable 5.1 (f)): (1) KONFIGURACIO-SZINTU - az IMS-vektor visszaolvasasa es osszevetese a kivanttal; determinisztikus es halozat-fuggetlen, de csak azt bizonyitja, amit a modem MOND. (2) VISELKEDES-SZINTU - 3-5 perces MPSS-duty-ablak kuszobbel (duty < 10% ES ebredes-utem ~3,1/s = a paging-DRX ujjlenyomat); a kuszob a mert sav-szoras (olcso 4,4-6,9%, draga 31-52%) koze lojve, es a check NAPLOZZA a savot/cellat, hogy egy FAIL savvaltaskent is olvashato legyen; a nulla-delta-ketertelmuseget statikus mezokkel dontse el. ☠️ A ketto egyutt zarja a kort: az 1. jelez ha valami visszairta a konfiguraciot, a 2. akkor is bukik, ha a konfiguracio 'jo' de a viselkedes megis draga
        · ★★★ AZ 56-OS CHECK MINDKET AGA MEGMUTATVA AZ ESZKOZON: IMS=off -> PASS (rc=0), IMS=on -> FAIL (rc=1) a pontos hibauzenettel. ☠️ ES A DEMONSTRACIO TALALT EGY HIBAT A CHECKBEN: az 'enabled' es az 'active' KET KULON kerdes - egy kezzel leallitott timer tovabbra is 'enabled'-et jelent, tehat a check atment, mikozben a kovetkezo bootig SEMMI nem allitana vissza a vektort. Javitva: mindkettot kerdezi, es kulon mondja meg, melyik hianyzik. ★★★★★ ES KOZBEN A RECONCILER ELESBEN FOGOTT EGY VALODI DRIFTET, KERDEZETLENUL: a cenzus 08:11:02-kor visszaallitotta az IMS-t on-ra, a timer 08:11:44-kor eszlelte ('want=off but sms,ut,video,voice,vowifi disagree') es 08:11:46-ra kijavitotta, visszaolvasott bizonyitekkal. Ez nem alltott demo volt, hanem a mechanizmus dolgozott egy driften, amit en okoztam veletlenul. Az 57-es check demoja fut
  […] 77. ★★★★ PROTOKOLL-SZABALY MINDEN JOVOBELI MERESRE: a blokk elejen ES vegen olvasd vissza az IMS-vektort (es tedd bele a capture-be). Egy varatlan revert a blokk kozepen pontosan az a nema allapotvaltas, ami a hangszoro-sagaban 16 napig lathatatlan maradt - es most mar TUDJUK, hogy a vektor vissza TUD allni magatol. Beepitendo az ims-ma2.sh/ims-ab.sh labaiba es a tervezett OCV-letraba
        · a kovetkezo meresre - a szabaly rogzitve, a beepitese az ims-ab.sh/ims-ma2.sh labaiba akkor esedekes, amikor a kovetkezo cenzust irom
  ...
  […] 79. ★★★★★ SONT-KALIBRACIO - AZ EGYETLEN TANU, AMI NEM A PMI632-N MEGY AT (Fable 5.1 c): a projekt MINDEN aram-szama egyetlen kalibracion ul - a QG-akkumulator, a current_now, ES a 2185 mAh-s referencia-gorbe is (annak mAh-tengelye ugyanennek a chipnek a cur_uA-jabol integralodott). Az ERSITES-hiba masodrendu (5% = 2,5 mA 50 mA-nel), de az OFFSET-hiba a '48 mA cel teljesitve' es az '58 mA nem' kozott dont. Az FP3 akkuja KIVEHETO ⇒ sont sorban a pakk es az erintkezok kozott + kulso multimeter, EGYSZERI egyideju kalibracio (gain+offset), nem cenzus. ☠️ Csapda: az akku-ID/termisztor-pineket NE szakitsa meg a sont. ☠️ EZ KAPUZZA a <=50 mA ABSZOLUT allitas kimondasat - a kulonbseg-allitast nem
        · a felhasznalora: fizikai munka (sont az akku es az erintkezok koze + kulso multimeter/logger), es egy delutan. Szoftverrel NEM kivalthato - ez a lenyege
...
OUTSIDE REVIEW: last 0.0 h ago, 0 result(s) recorded since.
  · Fable #5 (uj 5.1 kapcsolat) MEGJOTT es a szamainkat sorra ellenorizte: 31/53=58,5% OK, 5/29=17,2% OK, 35/56=62,5% OK, es a B-lab 8/30=26,7% szennyezettsege a josolt 21%-hoz kepest binomialisan 1 szigman belul (varhato 6,3+-2,2 db 30-bol) => a cnt-kapu elmelete SZAMSZERUEN is all. 255/3,39=75,2 s ablak, a cnt>=201 kapu 59,3 s-ot kovetel: a helyen volt. (Apro javitas: 140 minta/41 s = 3,41/s; a 3,39 akkor jon ki, ha 139 INTERVALLUMOT osztunk.) HAROM ELOIRAS: (1) A MEGFOGALMAZAS: a 40,1 vs 91-99 mA kontraszt RENDSZER-SZINTU, nem 'a modem-duty ara' -- a kontrafaktualis 'IMS on de az AP atalussza' csak ablacioval merheto, es azt a sajat 08-26-os leletunk blokkolja (nem-wake IRQ ezen a platformon MEGSZAKITJA az s2idle-t, tehat a lefegyverzett lab nem alvo APt ad hanem suspend-abort vihart). A dontes-relevans szam ugyis a rendszer-szintu. (2) A 40,1 MEG NEM 'mert': kell hozza (a) ismetles >=3 booton >=2 napon (a visszatero hibamintank: egy boot allapota -> a telefon tulajdonsaga), (b) egy hosszu B-blokk pihentetett radio-ki OCV-vegpontokkal, es a QG-integral osszevetese az OCV-delta-mAh-val, (c) KIMONDOTT hibasav. Es TILOS a visszavont feszultseg-lejtos ~40 mA-t alatamasztaskent idezni -- egy visszavont szam nem tanu. (3) LEVEZETES az offset-korlatra sont nelkul: az additiv epszilon a QG-be kozvetlenul megy (mert=I+eps), a feszultseg-gorbes utba viszont csak a kapacitas-skalan at (a 2185 mAh ~110 mA-s integralasbol jott) => ott a hiba ~I*(eps/110), 40 mA-nel 0,36*eps; ha a ket becsles delta-n belul egyezik, |eps| <= 1,6*delta. Egy 2-3 mA-es egyezes tehat +-3-5 mA-re korlatozza az offsetet SONT NELKUL. A gain masodrendu (5% gain 40 mA-nel 2 mA). PLUSZ egy torzitas amit ki kell mondani: az A-labak megtartott ablakai 7 ill. 11 db, A vs A' = 91,0 vs 98,8 => 7,8 mA szoras AZONOS konfiguracion, a draga allapot hibasavja +-4-5 mA. EJSZAKAI TERV (ember nelkul futtathato, a jelentes MINDKET gyenge mA-laba ala): 3x { reboot -> reconciler konvergal (naplobol bizonyitva) -> radio-ki rest + OCV -> B-cenzus 90 s-os ebresztovel 60-90 perc -> rest + OCV }, hajnalban egy A-lab kontrollnak. Ez egyszerre adja a replikaciot 3 booton, az OCV-vs-QG offset-korlatot, a reconciler boot-utani viselkedesenek 3x eles bizonyitekat, es 90 s-nal ~2-3x tobb megtartott ablakot. A (i) kuszob-ido-arany es a (ii) tengelymetszet-ablacio ELMARAD: a kontraszt mar haromszorosan lefedett, a tengelymetszet-modell pedig a kozvetlen B-meressel nyugdijba ment.
```
