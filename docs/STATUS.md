...
## ⟲ Resume — autonomous run, generated 2026-09-01 11:09 UTC
...
GOAL: pmOS fogyasztás felezése (≤50 mA) UT reagálási paraméterei mellett — a 8 órás modem-census (86 kör) eredményének feldolgozása és a következő lépések
  ...
  […] 13. ★★★★★ AZ ATMENET ELKAPASA (a 'mitol' kerdes): egyik mai kar sem mondja meg, mi emeli a dutyt 5%->36%-ra - csak azt, hol lakik az allapot. DUTY-LETRA az uptime menten: reboot utan 10-15 percenkent egy 600 s-os ablak, amig a lepcso be nem kovetkezik. Ez adja a MIKOR-t, es a lepcso alakja (ugras vs lassu emelkedes) a MIT-et. A tools/duty-vs-uptime.sh pont ezt kerdezi es hasznalatlanul all a repoban
        · Ugyanaz a futas mint a 11. tetel; 13:05-kor az elso ora leolvashato
  […] 14. ☠️ NAPLO-BISZEKCIO: 2026-08-31 06:12 (meg 5%) es 11:48 (mar 33,6%) kozott 5,6 ora telt el, amiben merések, MM-ujrainditasok es a patchelt MM telepitese tortent. A journal az eszkozon van; vegignezni, mi tortent a lepcso elott. Az elso dolog a futas utan, mert ssh kell hozza
        · ssh kell hozza, meres fut ~15:10-ig. ☠️ Es lehet, hogy mar targytalan (lasd a fenti jegyzetet a naplo illekonysagarol)
  [~] 15. ★★★★★ PERZISZTENS ALLAPOT: ez az egyetlen kategoria, ami tulel daemont, WiFit, kabelt, modem-power-cyclet, rebootot ES napszakot. Ket alcsoport, es szetvalaszthatok: (a) MODEM NV / carrier config - amit 08-31 reggel valami beleirt; (b) a HALOZAT allapota erre az IMSI-re. Szetvalasztas: detach+attach (a halozati oldalt ujraalkuja), illetve a modem NV/carrier-config olvasasa qmiclivel es osszevetes azzal, amit a leads/modem-carrier-config.md mar tud
        · ☠️ ATFOGALMAZVA, MIUTAN ELOLVASTAM AMIT A REPO MAR TUD. A leads/modem-idle-lte.md eliminacios tablaja a 21. soraban ott all a valasz alakja: pmOS adat-context NELKUL 34,8%, az orakulum ELO adatkapcsolattal (rmnet_data2, 10.124.125.20, internet.vodafone.net) 6,1% - UGYANAZON a cellan, UGYANAZZAL a firmware-rel. A carrier-config lead pedig ZART (mindket oldal ugyanazt futtatja), tehat a modem NV alcsoport nagyresz mar halott. ⇒ A helyes kerdes nem 'perzisztens allapot', hanem: EL-E ADAT-CONTEXT. Es ez megmagyarazna a 08-31 reggeli 5%-ot is, ha akkor eppen fel volt huzva egy bearer. ★ Es harom regime van, nem ketto: 2026-08-29-en ugyanez a stack 48,9-52,7%-ot mert ugyanazon a cellan
