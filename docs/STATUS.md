...
## ⟲ Resume — autonomous run, generated 2026-08-31 05:49 UTC
...
GOAL: pmOS fogyasztás felezése (≤50 mA) UT reagálási paraméterei mellett — a keret: fp3-pmaports/docs/power/NEXT-RUN.md
  ...
  [~] 19. ★★★★★ A STABIL KETOLDALI DIFFERENCIAL AZ LPASS, NEM AZ MPSS. Merve: pmOS LPASS awake 100,0% (2026-08-28 ES 2026-08-31 mindharom laban), orakulum LPASS 2,8-3,0% (ot UT-capture 2026-08-28). ⇒ a 100% NEM muszer-mutermek: ugyanaz a szamlalo az orakulumon 3%-ot ad. Kozben az MPSS duty NEM allando: 34,8% (08-28) -> 4,9% (08-31), ugyanazon a stacken. ⇒ A NAPOK OTA A D-PALYAT HAJTO 34,8% NEM REPRODUKALODIK; az adat 3 napja ott ult a captures/2026-08-28_modem-window-both/ fajlokban. Kovetkezo: (a) mennyibe kerul mA-ben az ebren tartott LPASS, (b) ebren marad-e s2idle ALATT is - mert akkor o a ~41 mA fo gyanusitottja, (c) a 16. tetel (smp2p sleepstate az ADSP-nek) ezzel sokkal erosebb lett.
        · ☠️ A TETEL ALAPALLITASA MEGDOLT 2026-08-31 (ld. a retracted-listat): az LPASS 100% MUSZER-MUTERMEK volt, forditott jellel - az LPASS ALSZIK. A (b) alkerdes ('ebren marad-e s2idle ALATT') ezzel TARGYTALAN: nem is ebren van idle-ben. A tetel helyebe a PRONTO lep, ami a javitas utan lett elso alkalommal lathato.
  ...
  [ ] 24. ★ PRONTO (WCNSS/WiFi) mint a ~41 mA gyanusitottja: 16,7-19,1% ebren pmOS-en, 21,3-23,1% az orakulumon. NEM a ket rendszer kulonbsege, de a padlo szempontjabol gazdatlan fogyaszto. Elore rogzitendo: a WiFi le van-e egyaltalan kapcsolva a padlo-meres alatt? A step-0 ejszaka kapui (MM stopped, bl_power=4, Discharging) a WiFi-t NEM ZARTAK KI - ha a wlan fent volt, a 48 mA tartalmazza a WCNSS koltseget is. Eloszor a NAPLOBOL kell megnezni, nem uj merest inditani.
