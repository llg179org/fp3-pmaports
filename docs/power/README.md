...
|---|---|
| ★★★★★ **is 40.3 mA a number or a leg?** — the cheap state is measured on **one leg of one boot**, with a within-leg band only. The boot-to-boot term is the dominant unknown and no single leg can see it. ☠️ **The replication route has now been tried twice and failed both times** (2026-09-02 and 2026-09-03): every leg was dropped for a median sleep of 9–18 s against a 90 s alarm, and both OCV endpoints hit their ceilings unrested, so there is still no band and no calibration bound. Neither night recorded what woke the AP, and that instrument gap — not another night — is what blocks a third attempt | [`bringup/captures/2026-09-05_118-night-triage/`](bringup/captures/2026-09-05_118-night-triage/README.md) |
