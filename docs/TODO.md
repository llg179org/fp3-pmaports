...
- [@] 142. Bert's regression: 0314fee3ce35 (msm8953.dtsi system-pc arm,psci-suspend-param 0x41000353 -> 0x42000353, affinity level 2) breaks his hx83112b touchscreen after resume (i2c -110/-6) on a second FP3; reproduce on ours (touch after suspend, before/after revert), and HOLD the msm8953.dtsi idle-state patch out of any series until understood
      ...
      until: ARM A is armed and waiting for the phone to be woken once (press power) - it then disarms the idle-suspend drop-in and runs 142-trigger.sh unattended, ~7 min, result in /home/fp3/142-armA-r88.txt. Criterion PRE-REGISTERED 2026-09-04 on #80-fp3: screen-off 5/5 must become 0/5. ARM B (tapping after a real suspend, driver bound) still needs a finger for minutes, not seconds. And Bert must say WHICH commits his tree carried - none of the three rail commits existed when he bisected 1ac2e21fbf3a
