...
|---|---|
| charging works | yes |
| **a charge finishes** | **yes** — the charger reaches `TERMINATE` within a minute of the current crossing the threshold, ending at `BATTERY_CHARGER_STATUS_1 = 0x45`, the value the vendor stack shows in the same state |
